...
import {
  ...
  play,
  nextPresentation,
} from "../src/browser/_internal/media.js";
import { fromOwnedReadableStream } from "../src/media-stream.js";
import { decodeAudioPacket } from "../src/browser/_internal/audio-packet.js";
...
test("worklet algorithm: one credit, explicit skipped frames, silent output and stop cleanup", async () => {
  ...
  await globals(
    ...
    async () => {
      try {
        await import("../src/browser/_internal/pcm-worklet.js");
