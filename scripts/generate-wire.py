...
def generate() -> str:
    files = {"google/protobuf/struct.proto": google_schema(ROOT / "fixtures/struct-descriptor.pb")}
    for path in sorted((ROOT / "fixtures/proto").rglob("*.proto")):
        name = path.relative_to(ROOT / "fixtures/proto").as_posix()
    ...
    out = [
        f"// GENERATED by scripts/generate-wire.py from canonical wire {WIRE_VERSION}. DO NOT EDIT.",
