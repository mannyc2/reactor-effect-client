...
import type { RawMedia } from "./Model.js";
...
export type PeerEvent =
  ...
  | { readonly type: "decoded"; readonly kind: "video" | "audio"; readonly name: string; readonly mid: string }
  | { readonly type: "error"; readonly error: ReactorError };

export interface Prepared { readonly sdp: string; readonly mapping: readonly Mapping[] }
